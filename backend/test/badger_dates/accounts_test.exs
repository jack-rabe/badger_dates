defmodule BadgerDates.AccountsTest do
  ...
  describe "users" do
    ...
    test "create_user/1 with valid data creates a user" do
      valid_attrs = %{age: 42, location: "some location", major: "some major", name: "some name"}
    ...
    test "update_user/2 with valid data updates the user" do
      user = user_fixture()
      update_attrs = %{age: 43, location: "some updated location", major: "some updated major", name: "some updated name"}
